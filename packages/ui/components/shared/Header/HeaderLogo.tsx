...
export function AllCourse_Background({ ...props }) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M144.274 103.052A103.145 103.145 0 0 1 46.242 31.86C41.192 19.962 28.595 0 .963 0h286.838c-33.051 0-44.593 28.66-47.343 37.444v-.371a102.937 102.937 0 0 1-96.182 65.979ZM288.764.01l-.582-.01h.582v.008ZM.002.01V0h.607L.08.007Z" />
    </svg>
  );
}
